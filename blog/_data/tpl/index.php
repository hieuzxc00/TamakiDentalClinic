...
<html lang="ja">
  <head>
    ...
    <title><?php echo $base_title; ?>一覧｜藤沢駅から徒歩5分の歯医者｜玉木歯科医院</title>
    <meta name="keywords" content="<?php echo $base_title; ?>一覧" />
    <meta name="description" content="<?php echo $base_title; ?>一覧" />
...
<div id="wrapper">
 <header>
  ...
  <main>
    <div id="top_info">
      <div class="inner">
          <p class="top_info-title"><?php echo $base_title; ?>一覧</p>
      </div>
    </div>
    <div id="topic_path">
      <div class="inner">
