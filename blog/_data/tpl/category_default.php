...
<head>
  ...
  <title><?php echo $current_category_name; ?>｜藤沢駅から徒歩5分の歯医者｜玉木歯科医院</title>
  ...
  <link rel="canonical" href="https://www.hideshima-dental.com/blog/<?php echo $current_category_url; ?>/">
  <!-- FAVICON -->
...
<div id="wrapper">
  ...
  <main id="main">
    <div id="top_info">
      <div class="inner">
          <p class="top_info-title"><?php if($current_category_id=='5'){echo 'セラミック・ホワイトニング';}else{echo $current_category_name;}?></p>
      </div>
    </div>
    <div id="topic_path">
      <div class="inner">
          <ul>
              ...
              <li><?php if($current_category_id=='5'){echo 'セラミック・ホワイトニング';}else{echo $current_category_name;}?></li>
          </ul>
      </div>
    </div>
    <div id="content">
      ...
      <div class="inner">
        <div class="section">
          <!-- *********   CATEGORIES   ********* -->
          <?php if($current_category_id!=1):?>
          <ul class="blog-cate mb30">
            <?php
...
?>
              <?php if($category_name == $current_category_name) : ?>
              <li class="active blog-cate-<?php echo $category_url; ?><?php if($category_id==1){echo ' none';} ?>"> <a href="../<?php echo $current_category_url; ?>/" class="udr-btn"><?php echo $current_category_name; ?></a> </li>
              <?php else : ?>
...
?>
        ...
        <?php endif;?>
          <!-- *********    /CATEGORIES ********* -->
          <?php if($current_category_id!=1):?>
          <!--<p class="attention"><img src="../../images/icon.png" alt="このアイコンが表示されている記事は外科処置時の写真が含まれているため、閲覧に注意してください。">このアイコンが表示されている記事は外科処置時の写真が含まれているため、閲覧に注意してください。</p>--><?php endif;?>
        </div>
        <section>
          <?php $limitNum = 10 ?>
          <?php
...
?>
                <div class="blog-item">
                  <p class="blog-item-url"><a href="../<?php echo $url; ?>"></a></p>
                  <div class="blog-item-top">
                      <p class="blog-item-sub">
                          <?php
	if($checkbox_Value){
?><span class="warning"></span><?php
	}
?>
                          <span class="cat cate-<?php echo $category_id; ?>"><?php echo $category_name; ?></span>
                          <span class="date"><?php echo $date; ?></span>
                      </p>
                      <p class="blog-item-ttl"><?php echo $title; ?></p>
                      <p class="blog-item-img">
                        <?php
	if($img_thumbnail_Value){
?><img src="<?php echo $img_thumbnail_Src; ?>" alt="<?php echo $title; ?>">
                          <?php
	}elseif($img_before_Value){
?> <img src="<?php echo $img_before_Src; ?>" alt="<?php echo $title; ?>">
                          <?php
	}elseif($img_after_Value){
?>
                          <img src="<?php echo $img_after_Src; ?>" alt="<?php echo $title; ?>">
                          <?php
	}elseif($img1_1_Value){
?>
                          <img src="<?php echo $img1_1_Src; ?>" alt="<?php echo $title; ?>">
                          <?php
	}elseif($news_img1_Value){
?>
                          <img src="<?php echo $news_img1_Src; ?>" alt="<?php echo $title; ?>">
                          <?php
	}else{
?>
                          <img src="../../images/udr-dummy.jpg" alt="<?php echo $title; ?>"> <?php
	}
?>
                      </p>
                    <?php
	if($tbl_txt5_Value || $tbl_txt6_Value){
?>
...
?>
                          <li>
                              <span class="blog-item-info-ttl">治療期間</span>
                              <span class="blog-item-info-txt"><?php echo $tbl_txt5_Value; ?></span>
                          </li>
                        <?php
	}
?>
...
?>
                          <li>
                              <span class="blog-item-info-ttl">治療費（税込）</span>
                              <span class="blog-item-info-txt"><?php echo $tbl_txt6_Value; ?></span>
                          </li>
                        <?php
	}
?>
...
?>
                  ...
                  <div class="blog-item-bottom">
                      <p class="blog-item-btn">詳細はこちら</p>
                  </div>
                </div>
              <?php
		foreach($field as $field_index=>$field_data){
...
?>
        ...
        <section>
          <div class="udr-box-04">
              <div class="box-item concept">
                  <p class="box-item-title">CONCEPT</p>
                  <p class="box-item-desc">正しい治療で“きちんと<br>噛める”喜びを追求</p>
                  <p class="box-item-btn"><a href="../../concept.html">玉木歯科医院のコンセプトはこちら</a></p>
              </div>
              <div class="box-item reserve">
                  <p class="box-item-title">RESERVE</p>
                  <p class="box-item-desc">お口全体を考えた包括的診療で<br>生涯噛める喜びと健康をあなたに</p>
                  <p class="box-item-btn"><a href="https://plus.dentamap.jp/apl/netuser/?id=4863" target="_blank" rel="noopener">ネット予約はこちら</a></p>
              </div>
          </div>
      </section>
      </div>
