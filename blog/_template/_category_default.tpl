...
<link rel="canonical" href="https://www.tamaki-dent.com/blog/{=$current_category_url=}/">
...
<p class="h-left-txtsp">藤沢駅徒歩5分</p>
  ...
  <div id="mainvisual">
    <div class="container">
      <h2><?php if($current_category_id=='5'){echo 'セラミック・ホワイトニング';}else{echo $current_category_name;}?></h2>
    </div>
  </div>
  <main id="main">
    <div id="content">
      ...
      <div class="section"> 
        ...
        <ul class="blog-cate mb30">
          <ONCategory>
            ...
            <li class="active blog-cate-{=$category_url=}<?php if($category_id==1){echo ' none';} ?>"> <a href="../{=$current_category_url=}">{=$current_category_name=}</a> </li>
            <?php else : ?>
      ...
      <div class="section">
        ...
        <ONContributeSearch page="@$_GET['p']" limit="$limitNum" category="@$current_category_id">
          <div class="blog-list">
            <ONContributeFetch>
              <div class="blog-item"> <a href="../{=$url=}"><ONIf condition="$checkbox_Value"><span class="warn-icon"></span></ONIf>
                <p class="blog-itm-cat cate-{=$category_id=}">{=$category_name=}</p>
                <p class="blog-date">{=$date=}</p>
                <p class="blog-itm-ttl">{=$title=}</p>
                <p class="blog-itm-img">
                  <ONIf condition="$img_thumbnail_Value"><img src="{=$img_thumbnail_Src=}" alt="{=$title=}">
                    <ONElseIf condition="$img_before_Value"> <img src="{=$img_before_Src=}" alt="{=$title=}">
                    <ONElseIf condition="$img_after_Value">
                    <img src="{=$img_after_Src=}" alt="{=$title=}">
                    <ONElseIf condition="$img1_1_Value">
                    <img src="{=$img1_1_Src=}" alt="{=$title=}">
                    <ONElseIf condition="$news_img1_Value">
                    <img src="{=$news_img1_Src=}" alt="{=$title=}">
                    <ONElse>
                    <img src="../../images/under_img01.jpg" alt="{=$title=}"> </ONIf>
                </p>
                <ONIf condition="$tbl_txt5_Value || $tbl_txt6_Value">
                  <ul class="blog-itm-info">
                    <ONIf condition="$tbl_txt5_Value">
                      <li><span class="blog-itm-info-ttl">治療期間</span><span class="blog-itm-info-txt">{=$tbl_txt5_Value=}
                      </span></li>
                    </ONIf>
                    
                      <ONIf condition="$tbl_txt6_Value">
                        <li><span class="blog-itm-info-ttl">治療費</span><span class="blog-itm-info-txt">{=$tbl_txt6_Value=}
                        </span></li>
                      </ONIf>
                  </ul>
                </ONIf>
                <p class="blog-itm-btn"><span>詳細はこちら</span></p>
                </a> </div>
            </ONContributeFetch>
          </div>
        </ONContributeSearch>
      ...
      <div class="section under-bnr">
        <ul>
          <li><a href="../../concept.html">
            <p class="under-bnr-en">CONCEPT</p>
            <p class="under-bnr-ttl">正しい治療で“きちんと噛める”喜びを追求</p>
            <p class="under-bnr-btn"><span>玉木歯科医院のコンセプトはこちら</span></p>
            </a></li>
          <li class="under-bnr-reserve"><a href="https://plus.dentamap.jp/apl/netuser/?id=4863&amp;fbclid=IwAR1FE8qflxq6Usr4kFVeeG5FmPSgd_XBIKeNIX8uw1XxT9SpM_RsjvRx0Og" target="_blank">
            <p class="under-bnr-en">RESERVE</p>
            <p class="under-bnr-ttl">お口全体を考えた包括的診療で<br>生涯噛める喜びと健康をあなたに</p>
            <p class="under-bnr-btn">初診専用ネット予約はこちら</p>
            </a></li-->
        </ul>
      </div>
    </div>
